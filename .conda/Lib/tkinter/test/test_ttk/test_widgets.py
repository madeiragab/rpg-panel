...
class StandardTtkOptionsTests(StandardOptionsTests):
    ...
    def test_configure_padding(self):
        ...
        self.checkParam(widget, "padding", (5, 6), expected=(5, 6), conv=padding_conv)
        self.checkParam(
            widget, "padding", (5, 6, 7), expected=(5, 6, 7), conv=padding_conv
        )
        self.checkParam(
            widget, "padding", (5, 6, 7, 8), expected=(5, 6, 7, 8), conv=padding_conv
        )
