...
class ListboxTest(AbstractWidgetTest, unittest.TestCase):
    ...
    def test_itemconfigure(self):
        ...
        self.assertEqual(widget.itemconfigure(0, "background"), (*prefix, "red"))
        self.assertEqual(widget.itemconfigure("end", "background"), (*prefix, "violet"))
        self.assertEqual(widget.itemconfigure("@0,0", "background"), (*prefix, "red"))
